...
class BPSKIDraw internal constructor(var dataStream: DataStream, frequency: Int, amplitude: Int) : JPanel() {
    ...
    fun setCycles(newCycles: Double) {
        ...
        for (i in 0 until points) {
            ...
            radians = if (str[stringPosCount] == '0') {
                Math.PI / points * i * 2 * newCycles + Math.PI / 2 + Math.PI
            } else {
                Math.PI / points * i * 2 * newCycles + Math.PI / 2
            }
